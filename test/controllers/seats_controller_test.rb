...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference('Seat.count') do
      post seats_url, params: { seat: { itinerary_id: @seat.itinerary_id, open_seat: @seat.open_seat, taken_seat: @seat.taken_seat } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { itinerary_id: @seat.itinerary_id, open_seat: @seat.open_seat, taken_seat: @seat.taken_seat } }
